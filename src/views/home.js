...
const Home = (props) => {
  return (
    <div className="home-container">
      <Helmet>
        <title>Selfish Powerful Okapi</title>
        <meta property="og:title" content="Selfish Powerful Okapi" />
      </Helmet>
      <header data-thq="thq-navbar" className="home-navbar-interactive">
        <span className="home-text">Plotly App</span>
        ...
        <div data-thq="thq-mobile-menu" className="home-mobile-menu">
          <div className="home-nav">
            ...
            <span className="home-text06">Plotly App</span>
